...
% 
% \paragraph{Kern eine Menge:} Menge ohne ihre Randpunkte (\ref{def:op})
% 
% \paragraph{Inneres einer Menge:} Kern der Menge
% 
% \paragraph{Kernoperator:} Operator, der jeder Menge ihren Kern zuordnet (\ref{def:op})
% 
% \paragraph{$\op_X$:} Kernoperator auf $X$ (\ref{def:op})
% 
...
\section*{Symbole}
    ...
    \paragraph{$\abg_X$} - \quad Menge der in $X$ \textit{abgeschlossenen Mengen} (\ref{def:CX})
