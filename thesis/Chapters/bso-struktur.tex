...
% 		2. bei Linienrepräsentanten: $B_1$ rechts korrekt? Oder eher $B_2$? (sonst keine Verbindung zum Flächenrepräsentant?) -> BH: $B_2$\\
% 		3. bei Punktrepräsentanten: Index $2$ an $C$ rechts nötig? -> BH: ja\\
% 		-> BH: ich denke, es ist doch besser, alle euklidischen Entitäten mit Indizes zu versehen}
