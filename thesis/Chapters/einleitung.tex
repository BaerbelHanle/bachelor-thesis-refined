...
In einem Manuskript aus dem Jahr 2010 [\cite{}] wurde ein Beweis für eine Subtheorie vorgestellt, die nur die drei primitiven Relationen $\GSReg$, $\Gsb$ und $\Gscoinc$ beinhaltet.
...
Es ist ein reiner Konsistenzbeweis, der nicht zum Ziel hat, die mit dem Brentanoraum verbundenen \textcolor{red}{Vorstellungen} abzubilden.
In dieser Arbeit wähle ich einen anderen Ansatz, der eben diese \textcolor{red}{Vorstellungen} in den Mittelpunkt stellt und sie zum Ausgangspunkt für die \textcolor{red}{vorgestellte} Interpretation macht.
