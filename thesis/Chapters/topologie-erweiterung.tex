...
%     Beweis: siehe \ref{anh:rand-lokal-gleich}
    ...
    \end{kor}
%     Beweis: direkte Folgerung aus dem vorhergehenden Satz.
    \todo[inline]{Ich hoffe, die Korrektur zweier Auftreten von $B_1$ zu $B$ ist korrekt.}
...
%     Beweis siehe Anhang \ref{anh:alt-def-einf-2}
    ...
    Folgendes Korollar bietet eine alternative Definition für einfach abgeschlossenen und offene Mengen, die die Operatoren $\co$ und $\oc$ benutzt. Er bildet die Grundlage für die meisten hier angeführten Beweise zu Aussagen über $\CO$ und $\OC$
...
%     
     \todo[inline]{Bild einscannen}
     
     \begin{figure}[ht]
        \centering
        \includegraphics[width=5cm]{gfx/rand-geht-weiter.png}
...
\section{Äußerer Rand}\label{sec:aeusserer-rand}
    ...
    \todo[inline]{korrigiertes Bild einscannen und einbinden}
    \begin{figure}[ht]
        \centering
...
%         \begin{subfigure}{.5\textwidth}
%             \centering
%             \includegraphics[width=.8\linewidth]{bearbeitet-22-04-25/pflasterbild-aeusserer-rp.png}
...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[height=7cm]{img/notationen-r3.png}
