\chapter{Nebenresultate}\label{chap:nebenresultate}
    In diesem Kapitel stelle ich einige Ideen vor, die in die vorliegende Version der \strukt keinen Eingang gefunden haben.
    
    Der \textemph{echte Rand} ist ein Begriff aus einer früheren Version der Arbeit, der mit der Einführung des Konzeptes der einfachen Menge obsolet geworden ist.
    
    Der \textemph{kaskadierte Randoperator} steht am anderen Ende der \glqq Evolution der \strukt\grqq.
    ...
    Abseits dieser Entwicklungslinie steht die Idee des \textemph{lokalen Zusammenhangs}, die schon in Kapitel \ref{chap:bso-grundideen} benutzt, dort jedoch nicht näher erläutert wurde. 
...
\section{Lokaler Zusammenhang}\label{sec:lok-zusammenhang}
    ...
    Die Idee des lokalen Zusammenhangs entstammt ursprünglich einer Diskussion zum Begriff der Continuousness, hat jedoch noch eine weitere Relevanz für die Modellbildung, die in \ref{sec:offene-fragen} thematisiert wurde:
